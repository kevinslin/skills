...
- [fin](active/fin/SKILL.md): Finalize a completed task by archiving any active `specy` spec and running `ag-learn` to propose retrospective improvements. Use at the end of implementation work when the requested scope is done and the spec state plus learnings should be brought to a clean finished state.
