...
- [mem](active/mem/SKILL.md): Route durable knowledge, merge workspace and home bases, inspect bundled schemas, and safely materialize managed or explicit repo-owned layouts through one CLI.
...
- [sc](active/sc/SKILL.md): Create, update, or directly optimize skills and SKILL.md content, using `$skill-name` references with synchronized dependency metadata plus canonical-source preflight, validation, packaging, and runtime synchronization.
