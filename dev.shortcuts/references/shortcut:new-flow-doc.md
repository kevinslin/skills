...
2. Copy @docs/project/flows/template-flow.md to
   @docs/project/architecture/current/flow-DESCRIPTION.md (filling in an appropriate
   DESCRIPTION of the component or feature being documented)

3. Begin to fill in the new flow document based on the user’s instructions,
