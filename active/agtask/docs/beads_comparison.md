...
| `todo/active/blocked/merging/done` | `open/in_progress/blocked/closed` | agtask states are inferred partly from Codex hooks and explicit lifecycle commands; `merging` is transient claim ownership. Beads states are explicit issue workflow state. |
