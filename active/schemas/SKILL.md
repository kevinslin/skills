...
- `code`: Specy-style code documentation tree under `$DOCS_ROOT/packages/{{module}}`, including dev/QA, reference catchalls, architecture, research, design, specs, flows, state, recipes, FAQ, and vendor docs. See `./references/code/schema.yaml`.
